...
html,body,[class*="css"],.stApp{font-family:'Cairo',sans-serif!important;direction:rtl;translate:no}.stApp,[data-testid="stAppViewContainer"]>.main{background:#f5f7fb;color:#111827}.block-container{max-width:1180px;padding-top:1.4rem;padding-bottom:3rem}#MainMenu,footer,header,[data-testid="stToolbar"],[data-testid="stDecoration"],[data-testid="stStatusWidget"],[data-testid="stSidebarNav"]{display:none!important}h1{font-size:32px!important;font-weight:800!important}h2{font-size:23px!important;font-weight:800!important}h3{font-size:19px!important;font-weight:700!important}
